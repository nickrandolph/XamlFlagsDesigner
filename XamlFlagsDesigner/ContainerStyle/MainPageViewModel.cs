...
namespace XamlFlagsDesigner.ContainerStyle
{
    ...
    {
        private OptionViewModel selectedItem;

        public List<OptionViewModel> Options { get; }

        public OptionViewModel SelectedItem { get => selectedItem; set => SetProperty(ref selectedItem, value, onChanged: ()=>OnSelectType(SelectedItem)); }
